...
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      -- On-site AC discoveries are NOT auto-created.
      -- Admin must confirm via dashboard before AC enters inventory.
      -- The payload is preserved on service_reports.ac_units for later review.
    END IF;
