-- 1. Drop the 4-arg overload (my previous migration) so handler calls the 3-arg version
DROP FUNCTION IF EXISTS public.technician_submit_report_v2(text, text, jsonb, integer);

-- 2. Fix 3-arg version: add ac_units to service_reports INSERT
