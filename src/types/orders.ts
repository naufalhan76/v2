// Consolidated types for Orders domain.

// Re-export canonical status types from the single source of truth.
export type { OrderStatus, LegacyOrderStatus, AnyOrderStatus } from '@/lib/order-status'
...
export type OrderItem = {
  ...
  status: import('@/lib/order-status').AnyOrderStatus;
  created_at: string;
  updated_at: string;
};
