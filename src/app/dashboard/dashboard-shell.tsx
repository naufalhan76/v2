  ...
  return (
    <div className="h-dvh w-full overflow-hidden" data-testid="dashboard-shell">
      ...
      <div className="md:hidden h-full min-h-0 flex flex-col">
        ...
        <header className="flex-none flex h-14 items-center gap-4 border-b border-border bg-background px-4">
        ...
        <main className="min-h-0 flex-1 overflow-y-auto overscroll-contain bg-surface-muted p-xl">
          {children}
        </main>
      </div>
      ...
      >
        ...
        <div className="flex h-full min-h-0 min-w-0 flex-col overflow-hidden">
          ...
          <main className="min-h-0 flex-1 overflow-y-auto overscroll-contain bg-surface-muted p-xl lg:p-huge">
            {children}
          </main>
        </div>
      </div>
