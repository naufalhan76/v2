...
const SERVICE_TYPES = [
  { value: 'REFILL_FREON', label: 'Refill Freon', dot: 'bg-status-assigned' },
  { value: 'CLEANING', label: 'Cleaning', dot: 'bg-status-completed' },
  { value: 'REPAIR', label: 'Repair', dot: 'bg-status-pending' },
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
        ...
        >
          <CardContent className='p-4 text-center'>
            <div className='w-3 h-3 rounded-full mx-auto mb-2 bg-status-assigned' />
        ...
        >
          <CardContent className='p-4 text-center'>
            <div className='w-3 h-3 rounded-full mx-auto mb-2 bg-status-pending' />
