  ...
  if (fill) {
    return (
      <div className={cn('relative overflow-hidden', className)}>
        ...
        />
        {isLoading && (
          <div className="absolute inset-0 bg-canvas-soft animate-pulse" />
        )}
        {hasError && (
          <div className="absolute inset-0 flex items-center justify-center bg-canvas-soft/20">
            <div className="text-center p-4">
              <div className="w-16 h-16 mx-auto mb-2 rounded-full bg-canvas-soft flex items-center justify-center">
              ...
              <p className="text-sm text-ink-mute">Failed to load image</p>
            </div>
          </div>
        )}
      </div>
  ...
  if (children) {
    return (
      <>
        ...
        {hasError && (
          <div className="script-error text-destructive text-sm">
