  ...
  if (fill) {
    return (
      <div className={cn('relative overflow-hidden', className)}>
        ...
        {hasError && (
          <div className="absolute inset-0 flex items-center justify-center bg-surface-muted/30">
            <div className="text-center p-4">
              <div className="w-16 h-16 mx-auto mb-2 rounded-full bg-surface-muted flex items-center justify-center">
