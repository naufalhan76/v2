  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-lg font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-hairline bg-background text-foreground hover:bg-canvas-soft",
        secondary:
          "bg-canvas-soft text-foreground hover:bg-canvas-soft/80",
        ghost: "text-foreground hover:bg-canvas-soft",
