...
export function TechnicianShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-full pb-24 relative">
      {isOffline && (
        <div className="fixed top-0 inset-x-0 z-50 bg-status-cancelled-bg text-status-cancelled px-4 py-2 flex items-center justify-center gap-2 pt-safe text-sm font-medium shadow-sm">
