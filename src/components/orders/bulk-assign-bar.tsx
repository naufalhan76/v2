...
export function BulkAssignBar({ selectedCount, onAssign, onClear }: BulkAssignBarProps) {
  return (
    <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2">
      <div className="flex items-center gap-3 rounded-lg border border-hairline bg-background px-4 py-3 shadow-lg">
        ...
        <Button
          ...
          variant="outline"
          onClick={onClear}
          className="h-8 gap-1.5 text-ink-mute hover:text-foreground"
        >
