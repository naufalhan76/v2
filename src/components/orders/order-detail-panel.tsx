  ...
  return (
    <>
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent className="w-full sm:max-w-xl p-4 sm:p-6 overflow-y-auto flex flex-col bg-background border-border">
          {isLoading || !order ? (
            <>
              <SheetHeader>
                <SheetTitle>
            ...
            <>
              ...
              <SheetFooter className="flex-col gap-2 sm:flex-row sm:gap-2 border-t border-border pt-4 mt-2">
                {canonical === 'PENDING' && (
                  <>
